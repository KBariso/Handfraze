      ...
      <div className="SinglePhraseContainer">
        <div className="PhraseandCommentsContainer">
          ...
          <iframe
            ...
            onError={(event) => {
              event.target.src =
                "https://play-lh.googleusercontent.com/4UPSnZVYh4pEeD85XXUAi3Lhdfuw54rGD2kcy--BA8t86Zuua1NpLQxUeVS7QzUZ91g";
              event.onerror = null;
            }}
          ...
          <div className="EditPhraseButton">
            {usersPhrase && !edit && (
              <button className="EditPhrase" onClick={() => setEdit(!edit)}>
                Edit Phrase
              </button>
            )}
          </div>
                  ...
                  <div>
                    {
                      <button
                        ...
                        id={category.id}
                        onClick={(e) => setSelectedPhrase(category.id)}
                      >
                        {category.title}
                      </button>
                    }
